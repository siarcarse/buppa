...
$city = $db2->doSql($sql);
$ciudad = $city['name'];
$sql = "SELECT calendar.id AS id, calendar.date_c AS date, (patient.name || ' ' || patient.lastname) AS patient, patient.rut AS rut, (ref_doctor.name || ' ' || ref_doctor.lastname) AS ref_doctor, patient.birthdate as birthdate
FROM calendar 
...
$report = str_replace('%date_inf%', $date_inf, $report);
