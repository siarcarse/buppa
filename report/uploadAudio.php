...
$target = "../../../uploads/audios/".$calendar_exam . "." . array_pop($ext);
...
$calendar_exam = str_replace("-", ",", $calendar_exam);

 
// check and process based on successful status 
if ($success === true) {
    $sql = "UPDATE calendar_exam SET exam_state='audio', audio='$target' WHERE id IN ($calendar_exam)";
    $db->doSql($sql);
