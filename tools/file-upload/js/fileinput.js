...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                content = '<button id="subirArchivo" type="submit" title="' + self.uploadTitle + '"class="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</button>';
            } else {
    ...
    $.fn.fileinput.defaults = {
        ...
        cancelTitle: 'Cancelar subida actual',
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede maximo permitido <b>{maxSize} KB</b>. Intenta nuevamente!',
        msgFilesTooMany: 'Numero de Archivos <b>({n})</b> excede limite permitido <b>{m}</b>. Intenta nuevamente!',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'No hay permisos para leer archivo "{name}".',
        ...
        msgInvalidFileType: 'tipo invalido "{name}". solo "{types}" soportados.',
        msgInvalidFileExtension: 'Extencion invalida "{name}". Solo "{extensions}" extenciones soportadas.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Error en Subida</span>',
        msgErrorClass: 'file-error-message',
        msgLoading: 'Cargando Archivos {index} de {files} &hellip;',
        msgProgress: 'Cargando Archivos {index} de {files} - {name} - {percent}% completado.',
